...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] p-4 text-center">
      <h1 className="text-[12rem] leading-48 font-black text-primary mb-4">
      ...
      <div className="flex flex-row flex-wrap justify-center items-center gap-4 mb-8 w-full max-w-md">
        <Link
          href="/"
      ...
      {!isAuthenticated && (
        <div className="border-t border-gray-200 pt-6 w-full max-w-md">
          <p className="text-gray-600 mb-4">Looking for your account?</p>
